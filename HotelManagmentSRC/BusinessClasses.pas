...
function TNastroiki._Get_M_Schit_dlya_kagd_otd: TBABoolean;
begin
  assert(ValidateMember('TNastroiki', 'Schit_dlya_kagd_otd', 29, TBABoolean));
  Result := TBABoolean(BoldMembers[29]);
end;

function TNastroiki._GetSchit_dlya_kagd_otd: Boolean;
begin
  Result := M_Schit_dlya_kagd_otd.AsBoolean;
end;

procedure TNastroiki._SetSchit_dlya_kagd_otd(const NewValue: Boolean);
begin
  M_Schit_dlya_kagd_otd.AsBoolean := NewValue;
end;

function TNastroiki._Get_M_Filt_arend: TBABoolean;
begin
  assert(ValidateMember('TNastroiki', 'Filt_arend', 30, TBABoolean));
  Result := TBABoolean(BoldMembers[30]);
end;

function TNastroiki._GetFilt_arend: Boolean;
begin
  Result := M_Filt_arend.AsBoolean;
end;

procedure TNastroiki._SetFilt_arend(const NewValue: Boolean);
begin
  M_Filt_arend.AsBoolean := NewValue;
end;

function TNastroiki._Get_M_Filt_arend_nach: TBADate;
begin
  assert(ValidateMember('TNastroiki', 'Filt_arend_nach', 31, TBADate));
  Result := TBADate(BoldMembers[31]);
end;

function TNastroiki._GetFilt_arend_nach: TDate;
begin
  Result := M_Filt_arend_nach.AsDate;
end;

procedure TNastroiki._SetFilt_arend_nach(const NewValue: TDate);
begin
  M_Filt_arend_nach.AsDate := NewValue;
end;

function TNastroiki._Get_M_Filt_arend_kon: TBADate;
begin
  assert(ValidateMember('TNastroiki', 'Filt_arend_kon', 32, TBADate));
  Result := TBADate(BoldMembers[32]);
end;

function TNastroiki._GetFilt_arend_kon: TDate;
begin
  Result := M_Filt_arend_kon.AsDate;
end;

procedure TNastroiki._SetFilt_arend_kon(const NewValue: TDate);
begin
  M_Filt_arend_kon.AsDate := NewValue;
end;

function TNastroiki._Getopr_nastr_dlya_klassa: TKlass_nomeraList;
begin
  assert(ValidateMember('TNastroiki', 'opr_nastr_dlya_klassa', 33, TKlass_nomeraList));
  Result := TKlass_nomeraList(BoldMembers[33]);
end;
