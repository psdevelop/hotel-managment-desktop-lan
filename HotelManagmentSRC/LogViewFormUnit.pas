...
begin
  BoldHandlesDM.bvhStarDate.Value.SetAsVariant(StartOfTheDay(DateTimePicker1.DateTime));
  BoldHandlesDM.bvhEndDate.Value.SetAsVariant(EndOfTheDay(DateTimePicker2.DateTime));
end;
